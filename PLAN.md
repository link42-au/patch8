...
| P4a | **Add canonical CVE Program lineage** | P3, P3b, P3c, P4 | Activate the registered fail-closed `CVEProject/cvelistV5` public-dataset rule, ingest an immutable commit, and emit CVE state/dates plus lineaged English CNA descriptions. Fixtures reject NVD-description copying, unregistered fields, missing CNA/provider/blob lineage, malformed schema versions, rejected records, and commit drift. | source-complete | planned |

...
| P4a | **Add canonical CVE Program lineage** | P3, P3b, P3c, P4 | The standard-library builder consumes only the exact official `CVEProject/cvelistV5` codeload archive at an immutable 40-hex commit. Compressed/expanded/member/record/time limits, exact origin/final URL, safe paths, schema versions, CVE/path identity, PUBLISHED state, CNA/assigner provider identity, full-record SHA-256, CVE/MITRE notice, sealed refetch-verified staging, and atomic activation fail closed. It emits source-specific CVE state/dates and every English CNA description while retaining a deterministic first-in-source-order pointer; rejected records and all ADP, affected, reference, supporting-media, NVD-description, and other unregistered content emit nothing. Five P4a fixture tests bring ingestion to 46 tests and cover malformed lineage/schema/path, commit/origin/redirect drift, byte/time/record limits, forged restart state, rejected records, stable observation identity, and byte-identical repeat builds. Official main resolved to `10c6b415a7a12a0c0fab006359939fcd34e2c78f`; exact-commit live shape canaries passed for representative 1999/2005/2020/2025/2026 records without retaining payloads. No full upstream build, Parquet, publication, or public dataset is claimed. | source-complete | **source-complete** |
